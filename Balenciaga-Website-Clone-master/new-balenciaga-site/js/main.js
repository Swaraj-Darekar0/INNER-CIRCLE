window.onload = function(){ 
    ...
    document.querySelector(".dark-light-icon").onclick = function() {
        ...
        // Update localStorage based on the current state of the body class
        if (document.body.classList.contains("active-dark-light-mode")) {
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    // Duplicate tweet cards for infinite scroll
    const tweetCarousel = document.querySelector('.tweet-carousel');
    if (tweetCarousel) {
        const tweetCards = tweetCarousel.innerHTML;
        tweetCarousel.innerHTML += tweetCards; // Duplicate for seamless loop
    }
